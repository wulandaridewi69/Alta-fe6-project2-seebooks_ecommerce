...
const Header = () => {
    ...
    return (
        <div className='header h-auto bg-cyan-900'>
                ...
                <div className='flex items-center py-2 gap-4'>
                    {token !== '0' ? (
                        <>
                            ...
                            <div className='col-5 flex -mr-16'>
                                <img src={Search} className='h-full rounded-l-md bg-white p-2' alt=''/>
                                <input className='w-full text-black p-1 rounded-r-md'></input>
                            </div>
                            <div className='col-1 flex max-w-10 pl-16'>
                                <img src={Cart} className='cursor-pointer' alt='' onClick={()=>navigate('/cart/6')}/>
                            </div>
                        ...
                        <>
                            ...
                            <div className='col-3 flex gap-4 justify-end'>
                                ...
                                <Button className="border-[0.1rem] rounded-md font-bold px-8 py-1 text-teal-600 bg-teal-50 hover:bg-teal-600 hover:text-slate-200 py-0 px-6" onClick={()=>navigate('/signup')}>Sign Up</Button>
                            </div>
                        </>
                    )}
                </div>
